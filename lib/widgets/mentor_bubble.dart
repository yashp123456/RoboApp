...
/// a one-off [override] message (e.g. a reaction to a failed test run).
class MentorBubble extends StatefulWidget {
  final List<String> tips;
  final String? override;

  const MentorBubble({super.key, required this.tips, this.override});
...
class _MentorBubbleState extends State<MentorBubble> {
  ...
  Widget build(BuildContext context) {
    ...
    final message = widget.override ?? tips[_index % tips.length];
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  ...
                  if (widget.override == null && tips.length > 1) ...[
